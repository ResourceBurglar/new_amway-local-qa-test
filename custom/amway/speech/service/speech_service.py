...
from service.local_entity_service import ChatBotDomain, NamespaceDomain
...
class SpeechText(BaseComposeBot):
    ...
    def transform(self) -> str:
        ...
        # 查询业务背景知识库信息
        busNamespaceModel = NamespaceDomain().find_by_id(self.namespace_id_business)
        ...
        # 查询风格背景知识库信息
        styleNamespaceModel = NamespaceDomain().find_by_id(self.namespace_id_style)
        ...
        # 发起问答
        chain_draft = ChainModel.get_instance(
